...
def totranslate(update: Update, context: CallbackContext) -> None:
    ...
    if not reply_msg:
        message.reply_text(
            ...
            "ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ sᴇᴇ [ʟɪsᴛ ᴏғ ᴀᴠᴀɪʟᴀʙʟᴇ ʟᴀɴɢᴜᴀɢᴇ ᴄᴏᴅᴇs](https://t.me/honey_networks).",
            parse_mode="markdown",
...
Mukesh = "https://graph.org/file/7579c2d496d2c075f3092.jpg"
...
**˹Kᴀʀᴜᴍɪ˼ sᴏᴜʀᴄᴇ ɪs ɴᴏᴡ ᴩᴜʙʟɪᴄ ᴀɴᴅ ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ᴍᴀᴋᴇ ʏᴏᴜʀ ᴏᴡɴ ʙᴏᴛ.**
""",
